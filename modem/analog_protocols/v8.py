...
import modem.util.byte_receiver
...
class V8(modem.IAnalogProtocol):
    _SAMPLE_RATE = 8000
    _ANS_FREQUENCY = 2100
    ...
    def __init__(
        ...
        self._byte_receiver = modem.util.byte_receiver.BufferByteReceiver()
        ...
        self._v21 = modem.analog_protocols.v21.V21(self._bit_protocol, role)
        self._state: V8._State = (
            V8._State.CALLER_INITIAL_DELAY if role == modem.Role.CALLER
            else V8._State.CALLEE_INITIAL_DELAY
        )
        self._ans_detector = modem.util.goertzel.SlidingGoertzel(
            V8._SAMPLE_RATE,
            V8._ANS_FREQUENCY,
            V8._SAMPLE_RATE // 2
        )
        self._v21_delay = 0
        self._delay = 1 if role == modem.Role.CALLER else 0.2
        self._ans_generator = modem.util.tone.ToneGenerator(
            V8._SAMPLE_RATE,
            V8._ANS_FREQUENCY
        )

...
class FSKReceiver(modem.IAnalogReceiver):
    def __init__(self, bit_receiver: modem.IBitReceiver, f0: float, f1: float, samples_per_second: int, symbols_per_second: int) -> None:
...
class FSKSender(modem.IAnalogProvider):
    def __init__(self, bit_provider: modem.IBitProvider, f0: float, f1: float, samples_per_second: int, symbols_per_second: int) -> None:
